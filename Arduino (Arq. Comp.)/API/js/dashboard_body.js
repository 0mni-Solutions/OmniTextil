...
function UMI_line_graph() {
    ...
    gradient = contextoDht11Umidade.createLinearGradient(0, 0, 0, 450);
...
function UMI_bar_graph() {
    ...
    var dataBars = [40, 46, 38, 48, 54, 62, 49];
...
function TEMP_line_graph() {
    ...
    gradient = contextoDht11Temperatura.createLinearGradient(0, 0, 0, 450);
